<?php 
    session_start();
    if(isset($_POST['add_audi'])){
        $connection = mysqli_connect("localhost","root","");
        $db = mysqli_select_db($connection,"project");
        $query = "insert into auditoriums (audi_name,audi_capacity,audi_cost,audi_status) values('$_POST[audi]',$_POST[cap],$_POST[cost],0)";
        $query_run = mysqli_query($connection,$query);
        if($_SESSION['name'] == 'admin'){
            header("location:redirect_audi.php");   
        }
   } 
?>
                    ...
                    <div class="col-12">
                        <nav class="main-nav">
                            ...
                            <li class="scroll-to-section"><a href="grades.php">VIEW GRADES</a></li> 
                                <li class="scroll-to-section"><a href="admin.php"><center>ADD ADMIN</center></a></li>
                            </ul>      
