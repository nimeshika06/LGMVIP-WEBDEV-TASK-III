            ...
            <div class="col-md-12" style="overflow: scroll;">
                <table class="table">
                    <thead>
                        ...
                        <th><center>gpa1</center></th>
                        <th><center>p2</center></th>
                        <th><center>gpa2</center></th>
                        <th><center>p3</center></th>
                        <th><center>gpa3</center></th>
                        <th><center>p4</center></th>
                        <th><center>gpa4</center></th>
                        <th><center>p5</center></th>
                        <th><center>gpa5</center></th>
                        <th><center>p6</center></th>
                        <th><center>gpa6</center></th>
                        <th><center>p7</center></th>
                        <th><center>gpa7</center></th>
                        <th><center>p8</center></th>
                        <th><center>gpa8</center></th>
                        <th><center>p9</center></th>
                        <th><center>gpa9</center></th>
                        <th><center>p10</center></th>
                        <th><center>gpa10</center></th>
                        <th><center>p11</center></th>
                        <th><center>gpa11</center></th>
                        </tr> 
                    </thead>
                        ...
                        while($row = mysqli_fetch_assoc($query_run)){
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><center><?php echo $row['p1'];?></center></td>
                                    <td><center><?php echo $row['gpa1'];?></center></td>
                                    <td><center><?php echo $row['p2'];?></center></td>
                                    <td><center><?php echo $row['gpa2'];?></center></td>
                                    <td><center><?php echo $row['p3'];?></center></td>
                                    <td><center><?php echo $row['gpa3'];?></center></td>
                                    <td><center><?php echo $row['p4'];?></center></td>
                                    <td><center><?php echo $row['gpa4'];?></center></td>
                                    <td><center><?php echo $row['p5'];?></center></td>
                                    <td><center><?php echo $row['gpa5'];?></center></td>
                                    <td><center><?php echo $row['p6'];?></center></td>
                                    <td><center><?php echo $row['gpa6'];?></center></td>
                                    <td><center><?php echo $row['p7'];?></center></td>
                                    <td><center><?php echo $row['gpa7'];?></center></td>
                                    <td><center><?php echo $row['p8'];?></center></td>
                                    <td><center><?php echo $row['gpa8'];?></center></td>
                                    <td><center><?php echo $row['p9'];?></center></td>
                                    <td><center><?php echo $row['gpa9'];?></center></td>
                                    <td><center><?php echo $row['p10'];?></center></td>
                                    <td><center><?php echo $row['gpa10'];?></center></td>
                                    <td><center><?php echo $row['p11'];?></center></td>
                                    <td><center><?php echo $row['gpa11'];?></center></td>
                                </tr>
                            <?php
                        }
                    ?>
